...
def PostCd(input):
    # Function will accept a validated postal code and format it to A1A A1A

    postCd = input[0:3] + " " + input[3:]

    return postCd

def TenDigitPh(input):
    # Function will accept a validated 10-digit phone number and format it to 111-222-3333

    phNum = input[0:3] + "-" + input[3:6] + "-" + input[6:]
